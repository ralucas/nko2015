...
~~~sh
# getting the code
git clone git@github.com:nko5/nodedenver.git && cd ./nodedenver/
...
# deploying to Modulus (to http://nodedenver.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/nodedenver" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
